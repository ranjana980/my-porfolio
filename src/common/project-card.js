export default function ProjectCard({ img, title, url, sortDescription,onClick,route,type }) {
  return (
    <div className="br xs:mt-5 xl:mt-0  p-4  bg-[#ECF0F3]  drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)] hover:scale-95   w-[450px]  hover:bg-blue-400" onClick={()=>onClick(type,route)}>
