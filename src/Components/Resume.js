        ...
        <div className="xl:flex xl:row lg:row lg:flex ">
          <div className="xl:pl-20 xs:pl-[0px] flex">
            <div className="mt-5 ">
              ...
              <div className="line "/>
              <div className="h-[10px] relative left-[17px] w-[10px] rounded-[50%] bg-[#ECF0F3] border-solid border-[3px] border-blue-500"/>
            </div>
          ...
          <div className="mt-5">
            <h1 className="text-[20px] xl:ml-[273px] xs:ml-[48px] font-bold xl:mb-3 xs:mb-1">
              Job Experience
            </h1>
            <div className="flex">
              <div className="xl:pl-[204px] xs:pl-[0px]">
                <div className=" ">
                  ...
                  <div className="line1"/>
                  <div className="h-[10px] relative left-[20px] w-[10px] rounded-[50%] bg-[#ECF0F3] border-solid border-[3px] border-blue-500"/>
                </div>
              </div>
              <Qualification
                year="2021 - 2022"
                ...
                explaination={
                  <div className="mt-2">
                   {` I have worked 13month in xpressCure technology. I have
