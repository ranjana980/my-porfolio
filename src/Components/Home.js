            ...
            <div className='row xl:pl-15 xs:pl-[5px] xl:mt-36 xs:mt-[119px]'>
                ...
                <div className=' col-xs-12 col-sm-12 col-md-5  ml-5'>
                    <div className="br   xl:p-4 lg:p-4 bg-[#ECF0F3]  drop-shadow-[0_10px_10px_rgba(0,0,0,0.20)] xl:h-[450px]   xl:w-[550px] lg:h-[400px]   lg:w-[500px] xs:h-[400px] xs:hidden xs:mt-5 xl:block lg:block">
                        <img src="https://deerwalkcompware.com/training/uploads/courses/MernStack1.png" alt="mernstack"
                    ...
                    <div className='grid grid-cols-5 w-[370px] gap-1 mt-8 xl:ml-5 xs:ml-1'>
                        ...
                        <div className='bg-[#f6f6f6] hh-[45px] hover:scale-110 hover:text-[white] hover:bg-blue-500  w-[40px] p-2 rounded-md bg-[#ECF0F3]  drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)] '>
                            <a  rel="noreferrer"  className='hover:text-white hover:scale-120' href="https://www.instagram.com/ranjanachaudhary_123/" target="_blank"><Instagram /></a>
                        </div>
                        <div className='bg-[#f6f6f6] hh-[45px] hover:scale-110 hover:text-[white] hover:bg-blue-500  w-[40px] p-2 rounded-md bg-[#ECF0F3]  drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)] '>
                            <a rel="noreferrer" className='hover:text-white hover:scale-120' href="https://www.facebook.com/Ranjana24081996?mibextid=ZbWKwL" target="_blank"><Facebook /></a>
                        </div>
                    </div>
                </div>
            </div>
